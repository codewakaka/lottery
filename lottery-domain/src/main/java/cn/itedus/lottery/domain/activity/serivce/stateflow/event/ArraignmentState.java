package cn.itedus.lottery.domain.activity.serivce.stateflow.event;

import cn.itedus.lottery.common.Constants;
import cn.itedus.lottery.common.Result;
import cn.itedus.lottery.domain.activity.serivce.stateflow.AbstractState;
...
public class ArraignmentState extends AbstractState {
    ...
    public Result arraignment(Long activityId, Enum<Constants.ActivityState> currentState) {
        return Result.buildResult(Constants.ResponseCode.UN_ERROR, "待审核状态不可重复提神");
    }
    ...
    public Result checkRevoke(Long activityId, Enum<Constants.ActivityState> currentState) {
        ...
        return isSuccess ? Result.buildResult(Constants.ResponseCode.SUCCESS, "活动审核撤回到编辑中") : Result.buildErrorResult("活动状态变更失败");
    }
